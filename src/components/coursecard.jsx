...
const featureIcons = {
  Principles: (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4M9 12l2 2 4-4M9 12l2 2 4-4" />
    </svg>
  ),
  Workflows: (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    ">
      ...
      {isPopular && (
        <div className="absolute top-3 right-3 z-10 sm:top-4 sm:right-4">
          <span className="bg-[#EFAB47] text-[#315262] text-[10px] sm:text-xs font-bold px-2 py-1 sm:px-3 sm:py-1 rounded-full shadow-md flex items-center">
      ...
      <div className="relative h-64 sm:h-80 overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6">
          ...
          <p className="text-white text-sm sm:text-base mt-1 sm:mt-2 drop-shadow-md flex items-center">
        ...
        <div className="absolute top-4 left-4 sm:top-6 sm:left-6">
          <span className={`
            ...
            rounded-full shadow-md ${difficulty.color} flex items-center
          `}>
      ...
      <div className="p-4 sm:p-6">
        <div className="mb-4 sm:mb-6">
          <h4 className="font-bold text-[#315262] text-lg sm:text-xl mb-3 sm:mb-4 flex items-center">
